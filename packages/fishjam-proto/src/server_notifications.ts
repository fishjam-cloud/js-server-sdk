...
export interface ServerMessage {
  ...
  trackData?: ServerMessage_TrackData | undefined;
}
...
export interface ServerMessage_TrackData {
  roomId: string;
  peerId: string;
  track: ServerMessage_Track | undefined;
  data: Uint8Array;
...
export const ServerMessage: MessageFns<ServerMessage> = {
  encode(message: ServerMessage, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.trackData !== undefined) {
      ServerMessage_TrackData.encode(message.trackData, writer.uint32(210).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 26: {
          ...
          message.trackData = ServerMessage_TrackData.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): ServerMessage {
    return {
      ...
      viewerDisconnected: isSet(object.viewerDisconnected)
        ...
        : undefined,
      trackData: isSet(object.trackData) ? ServerMessage_TrackData.fromJSON(object.trackData) : undefined,
    };
  },
  ...
  toJSON(message: ServerMessage): unknown {
    ...
    if (message.trackData !== undefined) {
      obj.trackData = ServerMessage_TrackData.toJSON(message.trackData);
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<ServerMessage>, I>>(object: I): ServerMessage {
    ...
    message.trackData = (object.trackData !== undefined && object.trackData !== null)
      ? ServerMessage_TrackData.fromPartial(object.trackData)
      : undefined;
    return message;
  },
};
...
function createBaseServerMessage_TrackData(): ServerMessage_TrackData {
  return { roomId: "", peerId: "", track: undefined, data: new Uint8Array(0) };
}

export const ServerMessage_TrackData: MessageFns<ServerMessage_TrackData> = {
  encode(message: ServerMessage_TrackData, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.roomId !== "") {
      writer.uint32(10).string(message.roomId);
    }
    if (message.peerId !== "") {
    ...
    if (message.track !== undefined) {
      ServerMessage_Track.encode(message.track, writer.uint32(26).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ServerMessage_TrackData {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseServerMessage_TrackData();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): ServerMessage_TrackData {
    return {
      roomId: isSet(object.roomId) ? globalThis.String(object.roomId) : "",
      peerId: isSet(object.peerId) ? globalThis.String(object.peerId) : "",
      track: isSet(object.track) ? ServerMessage_Track.fromJSON(object.track) : undefined,
  ...
  toJSON(message: ServerMessage_TrackData): unknown {
    const obj: any = {};
    if (message.roomId !== "") {
      obj.roomId = message.roomId;
    }
  ...
  create<I extends Exact<DeepPartial<ServerMessage_TrackData>, I>>(base?: I): ServerMessage_TrackData {
    return ServerMessage_TrackData.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ServerMessage_TrackData>, I>>(object: I): ServerMessage_TrackData {
    const message = createBaseServerMessage_TrackData();
    message.roomId = object.roomId ?? "";
    message.peerId = object.peerId ?? "";
    message.track = (object.track !== undefined && object.track !== null)
