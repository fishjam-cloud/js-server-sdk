...
export interface ServerMessage_RecordingStatusChanged {
  recordingId: string;
...
export function serverMessage_RecordingStatusChanged_StatusFromJSON(
  object: any
  ...
  switch (object) {
    ...
    case 'UNRECOGNIZED':
    default:
      return ServerMessage_RecordingStatusChanged_Status.UNRECOGNIZED;
  }
}

export function serverMessage_RecordingStatusChanged_StatusToJSON(
  ...
  switch (object) {
    ...
    case ServerMessage_RecordingStatusChanged_Status.UNRECOGNIZED:
    default:
      return 'UNRECOGNIZED';
  }
}
...
function createBaseServerMessage(): ServerMessage {
  return {
    ...
    recordingStatusChanged: undefined,
...
export const ServerMessage: MessageFns<ServerMessage> = {
  encode(message: ServerMessage, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.recordingStatusChanged !== undefined) {
  ...
  fromJSON(object: any): ServerMessage {
    return {
      ...
      streamerDisconnected: isSet(object.streamerDisconnected)
        ...
        : undefined,
      recordingStatusChanged: isSet(object.recordingStatusChanged)
        ? ServerMessage_RecordingStatusChanged.fromJSON(object.recordingStatusChanged)
        : undefined,
  ...
  fromPartial<I extends Exact<DeepPartial<ServerMessage>, I>>(object: I): ServerMessage {
    ...
    message.recordingStatusChanged =
      object.recordingStatusChanged !== undefined && object.recordingStatusChanged !== null
        ? ServerMessage_RecordingStatusChanged.fromPartial(object.recordingStatusChanged)
        : undefined;
...
function createBaseServerMessage_RecordingStatusChanged(): ServerMessage_RecordingStatusChanged {
  return { recordingId: '', status: 0, metadata: '' };
}

export const ServerMessage_RecordingStatusChanged: MessageFns<ServerMessage_RecordingStatusChanged> = {
  encode(message: ServerMessage_RecordingStatusChanged, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ServerMessage_RecordingStatusChanged {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): ServerMessage_RecordingStatusChanged {
    return {
      recordingId: isSet(object.recordingId) ? globalThis.String(object.recordingId) : '',
      status: isSet(object.status) ? serverMessage_RecordingStatusChanged_StatusFromJSON(object.status) : 0,
      metadata: isSet(object.metadata) ? globalThis.String(object.metadata) : '',
    };
  },

  toJSON(message: ServerMessage_RecordingStatusChanged): unknown {
    const obj: any = {};
    if (message.recordingId !== '') {
  ...
  create<I extends Exact<DeepPartial<ServerMessage_RecordingStatusChanged>, I>>(
    base?: I
  ): ServerMessage_RecordingStatusChanged {
    return ServerMessage_RecordingStatusChanged.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ServerMessage_RecordingStatusChanged>, I>>(
    object: I
  ): ServerMessage_RecordingStatusChanged {
    const message = createBaseServerMessage_RecordingStatusChanged();
