...
/**
 * TrackForwardingApi - axios parameter creator
 * @export
 */
export const TrackForwardingApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * 
         * @summary Creates a track forwarding in a room
         * @param {string} roomId Room id
         * @param {TrackForwarding} trackForwarding Track forwardings
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
...
/**
 * TrackForwardingApi - functional programming interface
 * @export
 */
export const TrackForwardingApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = TrackForwardingApiAxiosParamCreator(configuration)
    return {
        /**
         * 
         * @summary Creates a track forwarding in a room
        ...
        async createTrackForwarding(roomId: string, trackForwarding: TrackForwarding, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['TrackForwardingApi.createTrackForwarding']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
/**
 * TrackForwardingApi - factory interface
 * @export
 */
export const TrackForwardingApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = TrackForwardingApiFp(configuration)
    return {
        /**
         * 
         * @summary Creates a track forwarding in a room
...
/**
 * TrackForwardingApi - object-oriented interface
 * @export
 * @class TrackForwardingApi
 * @extends {BaseAPI}
 */
export class TrackForwardingApi extends BaseAPI {
    /**
     * 
     * @summary Creates a track forwarding in a room
     * @param {string} roomId Room id
     ...
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof TrackForwardingApi
     */
    public createTrackForwarding(roomId: string, trackForwarding: TrackForwarding, options?: RawAxiosRequestConfig) {
        return TrackForwardingApiFp(this.configuration).createTrackForwarding(roomId, trackForwarding, options).then((request) => request(this.axios, this.basePath));
    }
}
