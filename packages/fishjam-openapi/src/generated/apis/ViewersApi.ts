...
import { type ViewerToken, ViewerTokenFromJSON, ViewerTokenToJSON } from '../models/ViewerToken';
...
export class ViewersApi extends runtime.BaseAPI {
   ...
   * Create a viewer
   */
  async createViewerRaw(
    requestParameters: CreateViewerRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<ViewerDetailsResponse>> {
   ...
   * Delete a viewer
   */
  async deleteViewerRaw(
    requestParameters: DeleteViewerRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
   ...
   */
  async generateViewerTokenRaw(
    requestParameters: GenerateViewerTokenRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<ViewerToken>> {
