...
import { type TrackForwarding, TrackForwardingFromJSON, TrackForwardingToJSON } from '../models/TrackForwarding';
...
export class TrackForwardingsApi extends runtime.BaseAPI {
   ...
   */
  async createTrackForwardingRequestOpts(
    requestParameters: CreateTrackForwardingRequest
   ...
   */
  async createTrackForwardingRaw(
    requestParameters: CreateTrackForwardingRequest,
