...
import { type StreamerToken, StreamerTokenFromJSON, StreamerTokenToJSON } from '../models/StreamerToken';
...
export class StreamersApi extends runtime.BaseAPI {
   ...
   * Create a streamer
   */
  async createStreamerRaw(
    requestParameters: CreateStreamerRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<StreamerDetailsResponse>> {
  ...
  async createStreamer(
    requestParameters: CreateStreamerRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<StreamerDetailsResponse> {
   ...
   * Delete a streamer
   */
  async deleteStreamerRaw(
    requestParameters: DeleteStreamerRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
   ...
   */
  async generateStreamerTokenRequestOpts(
    requestParameters: GenerateStreamerTokenRequest
   ...
   */
  async generateStreamerTokenRaw(
    requestParameters: GenerateStreamerTokenRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<StreamerToken>> {
