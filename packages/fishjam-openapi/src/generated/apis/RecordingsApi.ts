...
import {
    ...
    RecordingConfigFromJSON,
    RecordingConfigToJSON,
} from '../models/RecordingConfig';
import {
...
export class RecordingsApi extends runtime.BaseAPI {
     ...
     * Get a recording
     */
    async getRecordingRaw(requestParameters: GetRecordingRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RecordingDetailsResponse>> {
     ...
     * Get a recording
     */
    async getRecording(requestParameters: GetRecordingRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RecordingDetailsResponse> {
     ...
     * List recordings
     */
    async listRecordingsRaw(requestParameters: ListRecordingsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RecordingListResponse>> {
     ...
     * List recordings
     */
    async listRecordings(requestParameters: ListRecordingsRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RecordingListResponse> {
     ...
     * Stop a recording
     */
    async stopRecordingRaw(requestParameters: StopRecordingRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RecordingDetailsResponse>> {
     ...
     * Stop a recording
     */
    async stopRecording(requestParameters: StopRecordingRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RecordingDetailsResponse> {
