...
import { type RecordingStatus, RecordingStatusFromJSON, RecordingStatusToJSON } from '../models/RecordingStatus';
...
export class RecordingsApi extends runtime.BaseAPI {
  ...
  async createRecordingRaw(
    requestParameters: CreateRecordingOperationRequest,
