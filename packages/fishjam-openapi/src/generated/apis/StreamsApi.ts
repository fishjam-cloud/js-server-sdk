...
import { type StreamConfig, StreamConfigFromJSON, StreamConfigToJSON } from '../models/StreamConfig';
import {
...
export class StreamsApi extends runtime.BaseAPI {
  ...
  ): Promise<runtime.ApiResponse<StreamDetailsResponse>> {
   ...
   * List all streams
   */
  async getAllStreamsRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<StreamsListingResponse>> {
