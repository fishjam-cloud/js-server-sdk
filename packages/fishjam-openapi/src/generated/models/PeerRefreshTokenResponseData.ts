...
export function PeerRefreshTokenResponseDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): PeerRefreshTokenResponseData {
    if (json == null) {
        return json;
    }
    return {
...
export function PeerRefreshTokenResponseDataToJSONTyped(value?: PeerRefreshTokenResponseData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
