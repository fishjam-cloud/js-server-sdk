...
import { RoomTypeFromJSON, RoomTypeFromJSONTyped, RoomTypeToJSON, RoomTypeToJSONTyped } from './RoomType';
import type { VideoCodec } from './VideoCodec';
import { VideoCodecFromJSON, VideoCodecFromJSONTyped, VideoCodecToJSON, VideoCodecToJSONTyped } from './VideoCodec';
...
export function RoomConfigFromJSONTyped(json: any, ignoreDiscriminator: boolean): RoomConfig {
  ...
  return {
    batchWebhookNotifications:
      json['batchWebhookNotifications'] == null ? undefined : json['batchWebhookNotifications'],
