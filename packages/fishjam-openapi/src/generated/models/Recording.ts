...
import {
    RecordingFileFromJSON,
    RecordingFileFromJSONTyped,
    RecordingFileToJSON,
    RecordingFileToJSONTyped,
} from './RecordingFile';
...
export function RecordingFromJSONTyped(json: any, ignoreDiscriminator: boolean): Recording {
    ...
    return {
        ...
        'files': ((json['files'] as Array<any>).map(RecordingFileFromJSON)),
        'id': json['id'],
...
export function RecordingToJSONTyped(value?: Recording | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'files': ((value['files'] as Array<any>).map(RecordingFileToJSON)),
        'id': value['id'],
